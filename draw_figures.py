...
plt.figure(32)
plt.plot(actual_spread_2, predicted_spread_2, 'r*', markersize=2)
plt.xlabel("Actual spread")
plt.ylabel("Predicted spread")
plt.figure(33)
...
# spread achieved
#==============================================================================
df1 = pd.read_csv("/Users/macgx/Desktop/our-project/exp_flixster/sample_dataset/maxinf_CD/PCCov_0_0.001.txt_PCCov.txt",
            sep=' ', header=None,index_col = None, 
            names=['seed_number','g1','g2','influence_sp']) 
seed_number_1 = df1['seed_number'].values
influence_sp_1 = df1['influence_sp'].values

df2 = pd.read_csv("/Users/macgx/Desktop/our-project/exp_flickr/sample_dataset/maxinf_CD/PCCov_0_0.001.txt_PCCov.txt",
            sep=' ', header=None,index_col = None, 
            names=['seed_number','g1','g2','influence_sp']) 
seed_number_2 = df2['seed_number'].values
influence_sp_2 = df2['influence_sp'].values

df3 = pd.read_csv("/Users/macgx/Desktop/our-project/exp_digg/sample_dataset/maxinf_CD/PCCov_0_0.001.txt_PCCov.txt",
            sep=' ', header=None,index_col = None, 
            names=['seed_number','g1','g2','influence_sp']) 
